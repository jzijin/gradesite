		...
		<div id="all">
			<div id="back">
				...
				<div id="<?php echo $showRightColumn ? 'contentarea2' : 'contentarea'; ?>">
					...
					<?php if(JRequest::getCmd('view') =='article' && JRequest::getInt('id') == 6):?>
					<div class="row">
						<div class="col-4">
							<jdoc:include type="modules" name="position-left" style="beezDivision" headerLevel="3" />
						</div>
						<div class="col-4">
							<jdoc:include type="modules" name="position-middle" style="beezDivision" headerLevel="3" />
						</div>
						<div class="col-4">
							<jdoc:include type="modules" name="position-right" style="beezDivision" headerLevel="3" />
						</div>
					</div>
					<?php else:?>
